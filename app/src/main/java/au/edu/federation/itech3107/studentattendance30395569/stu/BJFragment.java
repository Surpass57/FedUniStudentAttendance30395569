...
import au.edu.federation.itech3107.studentattendance30395569.user.XSActivity;
import au.edu.federation.itech3107.studentattendance30395569.co.ClassAdapter;
import au.edu.federation.itech3107.studentattendance30395569.databinding.FragmentMineBinding;
...
import au.edu.federation.itech3107.studentattendance30395569.util.DialogUtil;
   ...
   private void initView() {
      ...
      mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
         ...
         public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
            ...
            startActivity(new Intent(getContext(), XSActivity.class)
